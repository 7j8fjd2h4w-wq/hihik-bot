...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    text = (
        ...
        "📜 *Краткие правила:*\n"
        "• Каждый день все получают 1 хи-хик, Юля — 4 (она продюсер хи-хика 🎬).\n"
        ...
        "• Если на счету есть хи-хики — трата бесплатна. Но если ты используешь "
        "хи-хик, когда на счету *пусто* (берёшь \"в долг\"), ты обязан заплатить "
        "штраф (от 50 ₸) в течение 48 часов — иначе все твои хи-хики обнуляются.\n"
        "• В магазине (/shop) можно купить апгрейды или хи-хики за деньги.\n"
        "• Можно поставить хи-хики на кон в хи-хик казино: /casino_coin и /casino_wheel.\n\n"
